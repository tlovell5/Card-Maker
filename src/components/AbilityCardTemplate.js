...
import abilityCardTemplateImage from "../assets/CardTemplate2.png"; // Adjust path as necessary
import "./ItemCardTemplate.css"; // Assuming you want to use the same CSS
